...
| assetsUrl                               | String | [link](https://github.com/AngeloAvv/flutter_flavorizr/releases/download/v2.1.5/assets.zip) | false    | A string containing the URL of the zip assets file. The default points to the current release |
